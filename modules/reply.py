...
# 常見問答表
faq = {
    "簡介":TextMessage(text="我是XXX做的聊天機器人"),
    "貼圖": StickerMessage(
        package_id="2",
        sticker_id="145"
    ),
...
menu = TemplateMessage(
    ...
    template=CarouselTemplate(
        columns=[
            ...
            CarouselColumn(
                # 卡片三圖片網址
                thumbnail_image_url="https://images.pexels.com/photos/8281246/pexels-photo-8281246.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2",
                title="主選單三",
                text="點選下方按鈕",
                actions=[
                    MessageAction(
